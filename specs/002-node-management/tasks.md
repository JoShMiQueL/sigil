...
- [X] T047 [P] [US4] Integration test for node CRUD in `apps/api/src/routes/nodes.spec.ts` (list, detail, update, delete, delete with servers error, regenerate credentials)
