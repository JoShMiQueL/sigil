...
| R8  | Templates & Groups       | Game catalog, template schema, PTDL_v2 egg import              | In: templates, groups, variables, import/export. Deferred: image build, server install.                | R2, R4             | in-progress   | specs/005-templates-groups/   |
