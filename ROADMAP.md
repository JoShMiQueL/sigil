...
| R4  | Node Management          | Register daemons, pairing tokens, regions, health check         | In: nodes, regions, pairing, heartbeat. Deferred: Docker, server lifecycle.                            | R1                 | in-progress | specs/002-node-management/   |
