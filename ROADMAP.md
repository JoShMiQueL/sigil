...
| R8  | Templates & Groups       | Game catalog, template schema, PTDL_v2 egg import              | In: templates, groups, variables, import/export, registry update detection. Deferred: image build, server install.                | R2, R4             | complete   | specs/005-templates-groups/   |
